...
async def sync_emails(
    ...
    if next_url:
        ...
        if not filters_provided:
            # Default to last 365 days if no filters provided
            end_date_default = datetime.utcnow()
    ...
    try:
            ...
            if error_code == "InefficientFilter":
                ...
                try:
                    ...
                    if fallback_response.status_code == 200:
                        ...
                        # Store filtered messages in MongoDB
                        stored_count, skipped_count = await store_emails_in_mongodb(filtered_messages, user_id)
        ...
        stored_count, skipped_count = await store_emails_in_mongodb(messages, user_id)
